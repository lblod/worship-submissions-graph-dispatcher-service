...
export const ORG_GRAPH_SUFFIX =
  process.env.ORG_GRAPH_SUFFIX ||
  "ABB_databankErediensten_LB_CompEnts_gebruiker";
export const DISPATCH_SOURCE_GRAPH =
  process.env.DISPATCH_SOURCE_GRAPH ||
  "http://mu.semte.ch/graphs/temp/for-dispatch";
